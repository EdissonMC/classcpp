...
/*
  This file let you make some test over queue implementation.
  Also you could use mostrarLaQueue() for show the internal data inside the array
  that let make a debug process.
*/
...
int main () {
    ...
    std::cout<<"\n<--Testing queue based in linkedList-- \n\n";
